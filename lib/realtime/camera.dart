...
typedef void Callback(List<dynamic> list, int h, int w,String text);
...
class _CameraFeedState extends State<CameraFeed> {
        ...
        controller.startImageStream((CameraImage img) {
          if (!isDetecting) {
            ...
            Tflite.detectObjectOnFrame(
               ...
               */
              List<dynamic> my_results = RP.desider(recognitions);
              widget.setRecognitions(my_results[0], img.height, img.width,my_results[1]);
              isDetecting = false;
            });
          }
        });
  ...
  Widget build(BuildContext context) {
    ...
    var screenRatio = 640 / 480;
    var previewRatio = 640 / 480;
